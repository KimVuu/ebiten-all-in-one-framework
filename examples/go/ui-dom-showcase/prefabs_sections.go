...
func prefabsSection() *uidom.Node {
	return uidom.Section(uidom.Props{
		ID:    "prefabs-section",
		Style: showcaseGroupStyle(),
	},
		uidom.Text("Game UI Prefabs", uidom.Props{
			ID:    "prefabs-section-title",
			Style: showcaseGroupTitleStyle(),
		}),
		uidom.TextBlock("Dialog, HUD, inventory, pause, settings, and tooltip prefabs sit on top of the same DOM tree primitives.", uidom.Props{
		...
		prefabs.Dialog(prefabs.DialogConfig{
			...
			Actions: []prefabs.DialogAction{
				...
				{ID: "dialog-confirm", Label: "Confirm", State: uidom.InteractionState{Selected: true}},
			},
		}),
		...
		prefabs.InventoryGrid(prefabs.InventoryGridConfig{
			...
			Slots: []prefabs.InventorySlot{
				{ID: "inv-slot-1", Label: "Potion", Quantity: 3, State: uidom.InteractionState{Selected: true}},
		...
		prefabs.PauseMenu(prefabs.PauseMenuConfig{
			...
			Items: []prefabs.MenuItem{
				{ID: "pause-resume", Label: "Resume", State: uidom.InteractionState{Focused: true}},
				{ID: "pause-settings", Label: "Settings"},
				{ID: "pause-quit", Label: "Quit", State: uidom.InteractionState{Disabled: true}},
			},
