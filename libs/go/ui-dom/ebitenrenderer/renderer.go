...
func (r *Renderer) Draw(screen *ebiten.Image, dom *uidom.DOM, viewport uidom.Viewport) *uidom.LayoutNode {
...
func drawNode(screen *ebiten.Image, layout *uidom.LayoutNode) {
...
func drawTextLines(screen *ebiten.Image, layout *uidom.LayoutNode, lines []string) {
...
func drawImage(screen *ebiten.Image, layout *uidom.LayoutNode) {
...
func drawInteractionState(screen *ebiten.Image, layout *uidom.LayoutNode) {
...
func uidomLineHeight(style uidom.Style) float64 {
